...
public class LocationYamlConverter implements Converter {
    ...
    public Object toConfig(Class<?> type, Object obj, ParameterizedType genericType) throws Exception {
        ...
        Location location = (cn.nukkit.level.Location) obj;
        saveMap.put("world", location.getLevel().getName());
    ...
    public Object fromConfig(Class type, Object section, ParameterizedType genericType) throws Exception {
        ...
        return new Location(
                ...
                yaw,
                pitch,
                Server.getInstance().getLevelByName((String) locationMap.get("world")));
    }

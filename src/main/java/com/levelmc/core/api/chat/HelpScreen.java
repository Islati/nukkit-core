...
public class HelpScreen {
    ...
    private TextFormat oddItemColor = TextFormat.GRAY;
    private TextFormat evenItemColor = TextFormat.GRAY;
     ...
     */
    public void setFlipColor(TextFormat oddItemColor, TextFormat evenItemColor) {
        if (oddItemColor == null) {
            oddItemColor = TextFormat.GRAY;
        }

        if (evenItemColor == null) {
            evenItemColor = TextFormat.GRAY;
        }
     ...
     * @param itemColor
     */
    public void setSimpleColor(TextFormat itemColor) {
...
//		s.sendMessage(messages);
    ...
    public class HelpScreenEntry {
        ...
        public String fromFormat(String format) {
            return TextFormat.colorize(format.replaceAll("<name>", NAME).replaceAll("<desc>", DESC));
        }
